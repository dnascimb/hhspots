...
CREATE TABLE `HOTSPOT` (
  ...
  `currentRating` double DEFAULT NULL,
  `downs` int(11) DEFAULT NULL,
  `originallyTaggedBy` varchar(255) DEFAULT NULL,
  `originallyTaggedDate` datetime DEFAULT NULL,
  `timesRated` int(11) DEFAULT NULL,
...
INSERT INTO `HOTSPOT` (`hotspot_id`, `currentRating`, `downs`, `originallyTaggedBy`, `originallyTaggedDate`, `timesRated`, `ups`) VALUES (1,80,NULL,'bob01','2011-10-01 19:45:41',1,NULL);
