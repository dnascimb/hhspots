...
<s:url var="url" namespace="/validation" action="save"/>
...
<s:form method="post" theme="xhtml" namespace="/validation" action="save" id="form">
...
<s:form method="post" theme="xhtml" namespace="/validation" action="save" id="form2">
    <s:textfield label="Name" name="name" />
    <s:textfield label="Age" name="age" />
    <s:textfield label="Favorite color" name="answer"/>
    <sx:submit 
